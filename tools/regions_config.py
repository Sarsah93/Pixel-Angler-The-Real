...
access  : 지역 접근 분류 (2026-09-01 사용자 결정). 미지정 = 'land' — 도보·대중교통권,
          심리스 확장 1차 대상. 'boat' = 도보권 도달 불가 섬 지역 — 데이터는 유지하되
          확장에서 분리, 추후 배 출조 콘텐츠(흘림낚시·다운샷·원도권 갯바위 출조) 업데이트
          시 개방. ※ 지역 bbox "안"의 부속 섬은 별도 처리 불요 — 심리스 빌드는 자동
          카브를 하지 않아(OSM 벡터 정본) 고립 컴포넌트로 남고, 걷기 컴포넌트 리포트로
          검수한다. 다리 연륙 섬(가덕도·거제도·돌산도 등)은 'land'.
...
REGIONS = {
    ...
    'dokdo': dict(bbox=(37.23540, 131.85280, 37.25002, 131.88649), seaEdges='NSEW',
                  spawn=(37.2394, 131.8686), spawnName='동도 접안시설', access='boat'),
    # 포항 → 구룡포·호미곶 해안 분할
