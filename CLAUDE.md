...
## 현재 진행 상황 (2026-09-10) — 이어받기 요약

> 상세·우선순위·로드맵은 **`IMPLEMENTATION_PLAN.md` 최상단 "🚧 다음 착수"** 참고.

- **전체 위치**: Phase 6(게임플레이 심화) — 맵 인프라·해루질·통발 인-맵 1차 완료 후
  **성장·생존 스펙 구현 중**(**P1~P7 + 스킬 트리 확장 완료** → 다음 = **P8 퀘스트 XP**).
  이후 대과제: 통발 심화 → 불요리 → 농장.
- **로드맵(사용자 확정 2026-09-11)**: **P8 퀘스트 XP → P9 도움말 → 통발 D2 → 불요리 → 농장**
  (농사 스킬 배선·타입은 농장 단계 이연). 맵 확정(육안)·OSM land 14개는 사용자 동반 병행 트랙.
- **직전 작업**: 130차 — **스킬 트리 확장 (a)(c)(d)(e)**: (a) 생존 지표 **최대치** 3노드
...
- **🚧 재개 지점**: ① **P8 퀘스트 XP·Ch1 리워크**(퀘스트 완료 XP 배선 + 일지 상태 실갱신) ·
  이어서 P9 도움말 planned → ready ② **맵 확정 — 사용자 육안**(109~115차 신설분: 래스터 도심 `'r'`·교차부 마킹·
...
- **완료**: 원물 자유 손질(돔류+방어류) · 넙치류 다섯장뜨기 · 회썰기 2뷰 + 사시미 플레이팅 ·
  **성장·생존 P1~P7 + 스킬 트리 확장**(레벨 200·**스킬 92노드 Σ=215**·생존 지표·상태이상·기절/사망·
  날씨 캐스팅·제작·구급품·보건소·시너지 히든) ·
