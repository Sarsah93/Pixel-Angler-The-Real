...
| S2 | [필드·캐스팅 (탑다운)](02-SYSTEMS/world-field.md) | 🟢 | `RegionFieldScene` · **`SeamlessChunks`** · **`FullMapPanel`(155 전체 지도 M·핀)** · 퀘스트 화살표·추적기 | 비주얼 4레이어 에셋, 사운드 · 핀은 세션 메모리 · **166 마을 사람 자율 배회(`FieldNpcSystem`) — 구 gem NPC 프롭 폐기** |
