...
**최근 변경 (2026-09-18 155차) — 인지 UX 전면: 퀘스트 화살표·추적 + 전체 지도(M)·핀 + 채비 고정 + 획득 토스트 + 사시미 별 5개 + 3끼 생존 재보정 + 초상 정합 + 혼잣말 퀘 우호도 정정** (사용자 지시 10건 + 캡처 추가 3건 — 실렌더 전 항목 · EN 잔존 0 · overflow 0 · pageerror 0 · 아티팩트 v9, 빌드 3/3·typecheck 0):
