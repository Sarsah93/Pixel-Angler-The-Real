...
**최근 변경 (2026-08-12 91차) — 무늬오징어 3구간 재구성: 껍질 2회 뜯기(추론 합성 2종) + 내장 뽑기 연출 2프레임 + 날개 2단 분리 (12→14스테이지)** (사용자 에셋 4점 + 지시 — core 실판정 28/28 · 실렌더 스테이지별 + 연출 프레임 실측, 빌드 4/4·typecheck 0):
