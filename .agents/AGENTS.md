...
9. **에이전트의 `git commit`/`git push` 금지** (사용자 지시 2026-08-14) — 커밋과 푸시는 **사용자가 직접** 한다.
...
**최근 변경 (2026-09-17 149차) — 구멍치기(테트라포드·사석) + M1-04 장소 게이트** (로드맵 다음 단계 — 실렌더 47/47 · pageerror 0, 빌드 3/3·typecheck 0):
