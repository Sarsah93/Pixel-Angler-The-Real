...
**최근 변경 (2026-09-11 131차) — 도움말 라이브러리 현행화(제작 카테고리 신설 · 생존 ready 전환 · 스킬 확장 반영) + 제작 UI 영문화** (사용자 지시 "반영된 모든 내용을 도움말 라이브러리에 내포" — 실렌더 ko 10/10·en 13/13·pageerror 0, 빌드 3/3·typecheck 0):
