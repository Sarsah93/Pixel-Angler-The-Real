...
| `←`/`→` | 드리프트 = **다트**(횡 임펄스 0.7m, 쿨다운 0.35s) / 파이팅 = **로드 스티어**(횡 러닝 밀당) |
...
**최근 주요 변경 (2026-07-23 35차) — 로드 벤딩 rev2 (하중 side 5분절 점증 · 일자 축 재교차 금지)** (ROD_BEND_SPEC rev2 반영 — 33차 OUT_AMP 되말림 폐기. 브라우저 4케이스+극한 클램프 검증, 빌드 4/4·typecheck 0):
