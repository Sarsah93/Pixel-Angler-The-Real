...
>    87차 구현은 **자동 검증만** 통과했다(core 실판정 12/12 + Playwright 실렌더). 사람이 조작해 본 적이 없어
>    **유도선 위치·드래그 체감·연출 타이밍·안내 문구**는 미확인이다. 나머지 3종 확장은 이 검증 뒤에 한다.
...
### ✅ 직전 완료 (87차, 2026-08-09) — 두족류 잠금 해제: 무늬오징어 14스테이지 완주
...
### ✅ 직전 완료 (86차, 2026-08-07) — 광어 박피 F9 실측 + 회썰기 유도선 dev 편집기
