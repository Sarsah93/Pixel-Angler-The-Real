...
export const FISH_BEHAVIOR_DB: FishBehaviorProfile[] = [
  ...
  },
  {
    ...
    lowTideWindow: [-30, 45],
    tempActivityCurve: [
      { tempC: 8, activity: 0.30 },
      { tempC: 12, activity: 0.80 },
      { tempC: 16, activity: 1.00 },
      { tempC: 20, activity: 0.70 },
      { tempC: 24, activity: 0.20 },
    ],
    floatFishingBonus: 1.20,
    semiFloatBonus: 1.10,
    bottomRigBonus: 1.40,
    lureSensitivity: 0.70,
    preferredDepthM: [5, 40],
    preferredHabitat: ['rocky_shore', 'breakwater'],
    legalClosedMonths: [],
    legalMinSizeCm: 23,
  },
  {
    ...
    optimalTideStrength: [0.15, 0.60],
    highTideWindow: [-60, 60],
    lowTideWindow: [-30, 30],
    tempActivityCurve: [
      { tempC: 8, activity: 0.25 },
      { tempC: 12, activity: 0.85 },
      { tempC: 16, activity: 1.00 },
      { tempC: 20, activity: 0.60 },
      { tempC: 24, activity: 0.15 },
    ],
    floatFishingBonus: 1.30,
    semiFloatBonus: 1.20,
    bottomRigBonus: 1.00,
    lureSensitivity: 0.50,
  ...
  {
    speciesId: 'red_snapper_rockfish',
    seasonActivity: {
      spring: 0.50,
      summer: 0.20,
      autumn: 0.70,
    ...
    optimalTideStrength: [0.30, 0.70],
    highTideWindow: [-90, 90],
    lowTideWindow: [-45, 45],
    tempActivityCurve: [
      { tempC: 8, activity: 0.35 },
      { tempC: 12, activity: 0.90 },
      { tempC: 16, activity: 1.00 },
      { tempC: 20, activity: 0.50 },
      { tempC: 24, activity: 0.10 },
    ],
    floatFishingBonus: 0.80,
    semiFloatBonus: 1.00,
    bottomRigBonus: 1.60,
    lureSensitivity: 0.30,
    preferredDepthM: [15, 80],
    preferredHabitat: ['rocky_shore', 'open_sea'],
    legalClosedMonths: [],
    legalMinSizeCm: undefined,
  },
  {
    speciesId: 'night_seabream',
    seasonActivity: {
      spring: 0.60,
      summer: 0.85,
      autumn: 0.90,
    ...
    optimalTideStrength: [0.40, 0.85],
    highTideWindow: [-90, 60],
    lowTideWindow: [-60, 30],
    tempActivityCurve: [
      { tempC: 12, activity: 0.10 },
      { tempC: 16, activity: 0.60 },
      { tempC: 20, activity: 0.95 },
      { tempC: 24, activity: 1.00 },
      { tempC: 28, activity: 0.80 },
    ],
    floatFishingBonus: 1.50,
    semiFloatBonus: 1.30,
    bottomRigBonus: 1.10,
    lureSensitivity: 0.40,
