...
export const SPOT_DATABASE: FishingSpotInfo[] = [
  ...
  // ─────────────────────────────────────────────
  {
    ...
    longitude: 128.6834,
    spotType: 'breakwater',
    mainSpeciesIds: ['largescale_blackfish', 'black_seabream', 'blue_rockfish'],
    isOperational: true,
    isRestricted: false,
  ...
  },
  {
    ...
    longitude: 129.4398,
    spotType: 'breakwater',
    mainSpeciesIds: ['black_seabream', 'blue_rockfish'],
    isOperational: true,
    isRestricted: false,
    facilities: ['parking', 'restroom', 'bait_shop'],
    hasRentalService: false,
  ...
  },
  {
    ...
    longitude: 130.9125,
    spotType: 'breakwater',
    mainSpeciesIds: ['blue_rockfish', 'red_seabream'],
    isOperational: true,
    isRestricted: false,
    facilities: ['parking', 'restroom'],
    hasRentalService: false,
  ...
  },
  {
    ...
    longitude: 131.8672,
    spotType: 'rocky_shore',
    mainSpeciesIds: ['blue_rockfish', 'red_seabream', 'amberjack'],
    isOperational: true,
    isRestricted: false,
    facilities: [],
    hasRentalService: false,
