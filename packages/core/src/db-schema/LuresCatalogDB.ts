...
export const LURES_CATALOG_DB: LureSpec[] = [
  ...
  // 소프트 저크베이트 · Fluid · Shad Minnow Worm (다트 액션 — 농어/연안 광어)
  {
    ...
    speciesWeightBias: { sea_bass: 0.20, flatfish: 0.15 },
  },
  {
  ...
  // 플러그/미노우 · Prism Aqua · Dive Shad 95S (플로팅/싱킹 2종)
  {
    ...
    actionFlags: ['wobble'],
    // 미노잉 = 농어/삼치 (2026-07 리서치 매핑)
    speciesWeightBias: { sea_bass: 0.20, spanish_mackerel: 0.15 },
  },
  {
  ...
  // 스푼 · Blade Studio · Classic Spoon (불규칙 폴링 유인 — 삼치/농어)
  {
    ...
    speciesWeightBias: { spanish_mackerel: 0.18, sea_bass: 0.12 },
  },
  {
  ...
  // 메탈지그 · Iron Forge · Hyper Bullet (초고속 싱킹, C_d -35% 초장타 — 지깅 핵심)
  {
    ...
    actionFlags: ['flash'],
    // 지깅 청물 전군 + 대구 (2026-07 리서치 매핑)
    speciesWeightBias: {
      yellowtail: 0.15, amberjack: 0.12, greater_amberjack: 0.12,
      spanish_mackerel: 0.15, pacific_cod: 0.12, sea_bass: 0.08, chub_mackerel: 0.10,
    },
  },
  {
  ...
  // 타이라바 · Deep Ruby · Round Head Rubber (참돔 전용 — 바닥 찍고 등속 릴링/폴링)
  {
    id: 'lure_tairaba_45', nameKo: '라운드 헤드 러버 45g', nameEn: 'Round Head Rubber 45g',
    brand: 'Deep Ruby', family: 'hard', kind: 'tairaba', sizeLabel: '45g',
    weightG: 45.0, sinkType: 'fast_sinking', sinkRateMps: 0.85, dragCoefficient: 0.48,
    fallLureWeight: 0.25, actionFlags: ['wobble'],
    speciesWeightBias: { red_seabream: 0.30, flatfish: 0.08 },
  },
  {
    id: 'lure_tairaba_60', nameKo: '라운드 헤드 러버 60g', nameEn: 'Round Head Rubber 60g',
    brand: 'Deep Ruby', family: 'hard', kind: 'tairaba', sizeLabel: '60g',
    weightG: 60.0, sinkType: 'fast_sinking', sinkRateMps: 1.0, dragCoefficient: 0.48,
    fallLureWeight: 0.25, actionFlags: ['wobble'],
    speciesWeightBias: { red_seabream: 0.30, flatfish: 0.08 },
  },
];
