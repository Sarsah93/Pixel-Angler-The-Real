...
export const SKILL_DATABASE: SkillDef[] = [
  ...
  { id: 'life_cook', category: 'life', nameKo: '요리 손', nameEn: "Cook's Hands", descKo: '요리 완성도 +5%/랭크 — 불요리', descEn: 'Dish finish +5% per rank — fire cooking', tier: 3, maxRank: 2, costPerRank: 2, requires: [{ id: 'life_fillet', rank: 2 }], effect: mult('cooking_quality', 0.05), wired: true },
