...
export const TUNING: TuningConfig = {
  retrieve: { anchorYRatio: 0.75, scaleMax: 2.0, durationHintMs: 1200, mainLineWidth: 1.4 },
  chumThrow: { pointCount: 13, predictGhost: true, cloudBaseR: 6 },
...
export const TUNING_META: TuningParamMeta[] = [
  { path: 'retrieve.anchorYRatio', min: 0.65, max: 0.80, step: 0.01, category: 'feel', label: '회수 도달 Y비' },
  { path: 'retrieve.scaleMax', min: 1.6, max: 2.4, step: 0.05, category: 'feel', label: '회수 최대 배율' },
